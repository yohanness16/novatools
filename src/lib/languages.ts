...
const RAW_LANGUAGES: LanguageOption[] = [
  ...
  { code: 'yi', name: 'Yiddish', nativeName: 'ייִዲש', region: 'middle-eastern', whisperSupported: true, translateSupported: true, rtl: true },
...
// All supported languages strictly sorted alphabetically (A-Z)
export const SUPPORTED_LANGUAGES: LanguageOption[] = [...RAW_LANGUAGES].sort((a, b) =>
...
/**
 * Search languages by English name, native script, or code with alphabetical sorting
 */
